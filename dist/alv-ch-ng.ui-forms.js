...
;(function () {
    ...
    var module = angular.module('alv-ch-ng.ui-forms', ['alv-ch-ng.ui-core','ui.bootstrap.typeahead','ui.bootstrap.tooltip','ngLodash']);
    ...
    module.directive('formDatepicker', ['$compile','UiRenderService', function ($compile,UiRenderService) {
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                //config.language=I18nPropertyService.getCurrentLanguage();
                ...
                element.datepicker(config);
                /* todo translate
                scope.$root.$on('i18n:languageChanged', function () {
                    config.language=I18nPropertyService.getCurrentLanguage();
                    element.datepicker('remove');
                    element.datepicker(config);
                    element.datepicker('update',scope.ngModel);
    ...
    module.directive('formPlaceholder', ['$translate', function ($translate) {
        return {
            priority: 10,
            restrict: 'A',
            scope: {
    ...
    // todo to delete
    module.directive('formSelect', ['$translate','$timeout', function ($translate,$timeout) {
        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                scope.$watch('formSelect', function(){
