;(function() {
    describe("auth directive", function() {
        ...
        it('hides the element if the user is authenticated.',
            function() {
                inject(function ($compile, $rootScope) {
                    var scope = $rootScope.$new();
                    // get an element representation
                    var elem = angular.element('<span not-auth></span>');
        ...
        it('shows the element if the user is not authenticated.',
            function() {
                inject(function ($compile, $rootScope) {
        ...
        it('hides the element if a login occurs.',
            function() {
        ...
        it('shows the element if a logout occurs.',
            function() {
                inject(function ($compile, $rootScope, $httpBackend, SecurityService) {
                    $httpBackend.whenGET('/api/currentUser').respond(mockUser);
                    var scope = $rootScope.$new();
